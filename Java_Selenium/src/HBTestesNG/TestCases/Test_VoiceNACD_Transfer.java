...
@Test(groups= {"VoiceNACD_Transfer_ClassLevel"})
public class Test_VoiceNACD_Transfer extends TestCaseObject {	
	

	Test_VoiceNACD_Transfer() throws Exception{
		log.info("* Construction: Test_VoiceNACD_Transfer");

	}
	@BeforeClass
	public void beforeClass() throws Exception {
		log.info("* Before Class: Test_VoiceNACD_Transfer");
	...
	public void afterClass() throws Exception {
		log.info("* After Class: Test_VoiceNACD_Transfer");
	}
