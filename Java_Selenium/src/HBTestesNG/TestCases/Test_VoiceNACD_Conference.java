...
@Test(groups= {"VoiceNACD_Conference_ClassLevel"})
public class Test_VoiceNACD_Conference extends TestCaseObject {
	

	Test_VoiceNACD_Conference() throws Exception{
		log.info("* Construction: Test_VoiceNACD_Conference");

	}
	@BeforeClass
	public void beforeClass() throws Exception {
		log.info("* Before Class: Test_VoiceNACD_Conference");
	...
	public void afterClass() throws Exception {
		log.info("* After Class: Test_VoiceNACD_Conference");
	}
