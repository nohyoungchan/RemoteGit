...
public class Test_VoiceScript_Conference extends TestCaseObject {
	...
	Test_VoiceScript_Conference() throws Exception{
		log.info("* Construction: Test_VoiceScript_Conference");

	}
	@BeforeClass
	public void beforeClass() throws Exception {
		log.info("* Before Class: Test_VoiceScript_Conference");
	...
	public void afterClass() throws Exception {
		log.info("* After Class: Test_VoiceScript_Conference");
	}
