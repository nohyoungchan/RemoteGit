...
public class Config {
	...
	public void print() {
		...
		System.out.println("Delay between Agents: " + m_delayBetweenLogins);
		System.out.println("Def JS Engine URL: " + m_defaultJSEngineURL);
		System.out.println("Def JS Target URL: " + m_defaultJSTargetURL);
		System.out.println("Def Password: " + m_defaultUserPassword);
	...
	private boolean parseAgentConfig(Element aElement) {
		try {
			...
			String delayBetweenLogins = getTextValue(aElement, DELAYBETWEENLOGINS);
					
			m_defaultUserPassword = getTextValue(aElement, DEFAULTUSERPASS);
			
			if (m_defaultUserPassword == null || defaultJSTargetString == null || defaultJSEngineString == null || delayBetweenLogins == null) {
				System.out.println("ALL default values must be present (DefUserPass, DefEngineURL, DefTargetURL, DefLoginDelay");
				return (false);
			}
	
//			m_delayBetweenLogins = Integer.parseInt(delayBetweenLogins);
			m_delayBetweenLogins = Float.parseFloat(delayBetweenLogins);
	...
	public float getDelayBetweenLogins() {
		return (m_delayBetweenLogins);
	}
	...
	private float m_delayBetweenLogins;
	...
	private static final String DELAYBETWEENLOGINS = "DelayBetweenLogins";
